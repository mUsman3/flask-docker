        ...
        stage('Build image') {
            steps {
                script {
                    ...
                    try {
                        sh "docker build -t musman3/flask-k8s:${tagName} -t musman3/flask-k8s:latest -t musman3/flask-k8s:${env.BUILD_NUMBER} ."
                    } catch (Exception e) {
                        now = new Date()
                    ...
                    sh "docker push musman3/flask-k8s:${env.BUILD_NUMBER}"
                }
            }
        }
